public class Helloworld  {
  public static void main(String[] args){
    ...
    //variable Java naming conversion
   ...
   x = (x + 2) * 2 / (3 + 1); 
    ...
    // Step2: int value / int value -> int value 
    // Step 3 : 3 / 2 -> 1
    ...
    //Step 2: double value / int value -> double value
    //Step 3: 3.0 / 2.0 -> 1.5
    //Step 4: assign 1.5(double value) to double type varible(downcasting)
    // ! Not allow assign a higher level value to a lower level type of varible
    ...
    //!Decalre a hardcode long value, you should always add "L"
    long l2 = 2147483648L;// "L" -> declare  it is a long value
     ...
     // conversion
     float f4 = 10.22f;
     double d3 = f4; // safe. assign float value to double varible
     ...
     double d6 = 0.2+0.1;
     System.out.println(d6);//10.3000000000004
